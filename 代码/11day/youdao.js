this.seajs = {_seajs: this.seajs}, seajs.version = "1.3.1", seajs._util = {}, seajs._config = {
        ...
        var n, r, i, o = e, a = o.document, s = o.navigator, l = o.setTimeout, c = o.clearTimeout, u = o.setInterval,
            ...
            Y = new RegExp("^flash-(" + V.map(function (e) {
                ...
                if ((e = me(e)) && !Te(e)) return "ready" === e.type && !0 === q.overdue ? Ke.emit({
                    type: "error",
                    name: "flash-overdue"
                }) : (t = S({}, e), xe.call(this, t), "copy" === e.type && (n = (r = De(B)).data, z = r.formatMap), n)
            }, oe = function () {
                ...
                if ("string" == typeof e && e ? (t = e, e = {}) : "object" == typeof e && e && "string" == typeof e.type && e.type && (t = e.type), t) {
                    ...
                    }), "aftercopy" === e.type && (e = Oe(e, z)), e.target && !e.relatedTarget && (e.relatedTarget = ge(e.target)), ve(e)
                }
            }, ge = function (e) {
    ...
    var a = e("./jquery-1.7"), s = a("#loginAlert"), l = a("#dialogCover"), c = a("#loginWindow"),
        u = a(".third-login-qq"), f = a(".third-login-weixin"), d = a(".third-login-weibo"), p = e("./log"),
    ...
    t.init = function () {
        if (s.find(".dialog-alert--close").on("click", function () {
            ...
            e += window.encodeURIComponent(window.location.href), a(".login-out").attr("href", e)
        }
    ...
    return function (e, t) {
        ...
        var O = e.document, L = e.navigator, F = e.location, M = function () {
            ...
            }), (i = s.uaMatch(E)).browser && (s.browser[i.browser] = !0, s.browser.version = i.version), s.browser.webkit && (s.browser.safari = !0), f.test(" ") && (d = /^[\s\xA0]+/, p = /[\s\xA0]+$/), r = s(O), O.addEventListener ? a = function () {
        ...
        }), M.attrHooks.tabindex = M.propHooks.tabIndex, B = {
            get: function (e, n) {
                var r, i = M.prop(e, n);
        ...
        }, K || (z = {name: !0, id: !0}, P = M.valHooks.button = {
            get: function (e, n) {
                var r;
        ...
        Be = nt.exec(Pe.toLowerCase()) || [], M.fn.extend({
            load: function (e, n, r) {
    ...
    var r = function (e) {
        ...
        return {ts: r, bv: t, salt: i, sign: n.md5("fanyideskweb" + e + i + "n%A-rKaT5fb[Gy?;N5@Tj")}
    };
    ...
    !function () {
        ...
        if (F(), T.text(i), i > 5e3) {
            ...
            var s = a.substr(5e3);
            s = (s = s.trim()).substr(0, 3), f("#inputTargetError").text("有道翻译字数限制为5000字，“" + s + "”及其后面没有被翻译!").show(), T.addClass("fonts__overed")
